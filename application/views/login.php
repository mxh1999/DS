...
<div class="col-md-4 col-md-offset-4" style="background-color: white; background-color: rgba(248,248,255, 0.2);padding: 0px; border-width: 0px; top: 50px; height: 350px;">
  ...
  <div style="background-color: rgba(248,248,255,0.4);height: 302px;margin-top: 48px; padding-top: 70px;text-align: center;">
    <form action = "<?php echo This_URL ?>/Login/check" method = "post">
